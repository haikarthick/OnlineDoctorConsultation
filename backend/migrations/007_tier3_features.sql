-- Migration: 007_tier3_features.sql
-- Description: Innovative advanced features: disease_predictions, outbreak_zones,
--              genetic_profiles, lineage_pairs, iot_sensors, sensor_readings,
--              product_batches, traceability_events, qr_codes, workforce_tasks,
--              shift_schedules, report_templates, generated_reports
-- Depends on: 005_farm_enterprise_tables.sql, 006_tier2_features.sql
