-- Migration: 006_tier2_features.sql
-- Description: Advanced farm management tables: health_observations, breeding_records,
--              feed_inventory, feed_consumption_logs, compliance_documents, financial_records,
--              alert_rules, alert_events. Also extends animals with health/breeding fields.
-- Depends on: 005_farm_enterprise_tables.sql
...
-- ============================================================
-- EXTEND ANIMALS TABLE (health/breeding fields)
-- ============================================================
DO $$ BEGIN
