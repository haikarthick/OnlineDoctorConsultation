-- Migration: 005_farm_enterprise_tables.sql
-- Description: Farm/enterprise management tables (enterprises, enterprise_members, animal_groups,
--              locations, movement_records, treatment_campaigns) + extend animals/users/bookings
-- These tables are also in docker/init.sql for fresh deploys. This file handles existing databases.
...
EXCEPTION WHEN others THEN
  RAISE NOTICE 'Some animals columns may already exist: %', SQLERRM;
END $$;

-- ============================================================
-- E8. EXTEND USERS TABLE (add default_enterprise_id)
-- ============================================================
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN others THEN
  RAISE NOTICE 'Users column default_enterprise_id may already exist: %', SQLERRM;
END $$;
...
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN others THEN
  RAISE NOTICE 'Some bookings columns may already exist: %', SQLERRM;
END $$;
