...
type Tab = 'overview' | 'doctors' | 'departments' | 'services' | 'documents' | 'settings'
...
const VetHospitalManage: React.FC = () => {
  ...
  const handleAdminReview = async () => {
    ...
    } catch (err: any) { flash(err?.response?.data?.message || 'Review failed', true) }
  }
  ...
  const handleDoctorSubmit = async (e: React.FormEvent) => {
    ...
    } catch (err: any) { flash(err?.response?.data?.message || 'Operation failed', true) }
  }
  ...
  const handleDeptSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setShowAddDept(false); setEditDept(null)
  ...
  const handleServiceSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setShowAddService(false); setEditService(null)
  ...
  const handleSettingsSave = async (e: React.FormEvent) => {
    ...
    } catch (err: any) { flash(err?.response?.data?.message || 'Update failed', true) }
  }
  ...
  return (
    <div className="module-page">
      ...
      <div className="vh-profile-tabs">
        {(['overview','doctors','departments','services','documents','settings'] as Tab[]).map(t => (
      ...
      {activeTab === 'doctors' && (
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
            ...
            <button className="btn-primary" onClick={() => { setEditDoctor(null); setDoctorForm({ doctorId: '', hospitalRole: 'staff', employmentType: 'full_time', departmentId: '', title: '', consultationFee: '', isPrimaryHospital: false }); setShowAddDoctor(true) }}>+ Add Doctor</button>
          </div>
          {doctors.length === 0
      ...
      {showAddDoctor && (
        <div className="modal-overlay" onClick={() => { setShowAddDoctor(false); setEditDoctor(null) }}>
          <div className="modal-content" style={{ maxWidth: 480 }} onClick={e => e.stopPropagation()}>
            <button className="modal-close" onClick={() => { setShowAddDoctor(false); setEditDoctor(null) }}>✕</button>
            ...
            <form onSubmit={handleDoctorSubmit} className="vh-form">
              {!editDoctor && (
                <div className="form-group">
                  ...
                  <input required value={doctorForm.doctorId} onChange={e => setDoctorForm(f => ({ ...f, doctorId: e.target.value }))} placeholder="Vet user ID" />
                </div>
              )}
              <div className="form-row">
                <div className="form-group">
              ...
              <div className="form-actions">
                <button type="button" className="btn-secondary" onClick={() => { setShowAddDoctor(false); setEditDoctor(null) }}>Cancel</button>
      ...
      {showAddDept && (
        <div className="modal-overlay" onClick={() => { setShowAddDept(false); setEditDept(null) }}>
          <div className="modal-content" style={{ maxWidth: 480 }} onClick={e => e.stopPropagation()}>
            <button className="modal-close" onClick={() => { setShowAddDept(false); setEditDept(null) }}>✕</button>
            ...
            <form onSubmit={handleDeptSubmit} className="vh-form">
              ...
              <div className="form-actions">
                <button type="button" className="btn-secondary" onClick={() => { setShowAddDept(false); setEditDept(null) }}>Cancel</button>
      ...
      {showAddService && (
        <div className="modal-overlay" onClick={() => { setShowAddService(false); setEditService(null) }}>
          <div className="modal-content" style={{ maxWidth: 480 }} onClick={e => e.stopPropagation()}>
            <button className="modal-close" onClick={() => { setShowAddService(false); setEditService(null) }}>✕</button>
            ...
            <form onSubmit={handleServiceSubmit} className="vh-form">
              ...
              <div className="form-actions">
                <button type="button" className="btn-secondary" onClick={() => { setShowAddService(false); setEditService(null) }}>Cancel</button>
      ...
      {reviewForm && (
        <div className="modal-overlay" onClick={() => setReviewForm(null)}>
          <div className="modal-content" style={{ maxWidth: 440 }} onClick={e => e.stopPropagation()}>
            <button className="modal-close" onClick={() => setReviewForm(null)}>✕</button>
            ...
            <div className="form-actions">
              <button type="button" className="btn-secondary" onClick={() => setReviewForm(null)}>Cancel</button>
              <button
                type="button"
