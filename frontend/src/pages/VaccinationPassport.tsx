...
<body>
  ...
  <div class="footer">Generated on ${new Date().toLocaleString()} · VetCare Platform</div>
  <br><button onclick="window.print()">Print / Save as PDF</button>
      ...
      // non-critical — download still happened
    } finally {
